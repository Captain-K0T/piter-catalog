  ...
  if (!restaurant) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-white p-4 text-center">
        ...
        <Link href="/" className="text-[#EC5E54] hover:underline">
    ...
    <div className="min-h-screen bg-white max-w-[480px] mx-auto pb-32">
      ...
      <header className="sticky top-0 z-10 bg-white border-b border-gray-200">
        <div className="px-4 py-4">
          <Link
            href="/"
            className="flex items-center gap-2 text-[#EC5E54] hover:opacity-80 transition-opacity"
          >
            <svg
              className="w-5 h-5"
              viewBox="0 0 24 24"
        ...
        <div className="space-y-2">
          ...
          {restaurant_link && restaurant_link.trim() !== '' && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full h-9 px-4 py-2 rounded-md text-sm font-medium border border-gray-200 bg-white text-gray-900 hover:bg-gray-50 transition-all"
            >
              <svg
                className="w-4 h-4"
                viewBox="0 0 24 24"
